...
export const createBlog = async (titulo,descripcion,contenido,imagen,autor,categoria) => {
    const blog = await Blog.create({id:crypto.randomUUID(),titulo,descripcion,contenido,imagen,autor,categoria});
    return blog
}
